...
type Props = {
  ...
  onCancel?: () => void;
  onSubmit: (
    values: SupplierProductInput | UpdateSupplierProductInput,
  ) => Promise<void>;
  submitLabel: string;
    ...
    ? [
        {
          ...
          label: t("purchasing.catalogue.purchaseUnitBase", {
            unit: selectedProduct.baseUnitOfMeasure,
          }),
        },
  ...
  async function submit(values: SupplierProductInput) {
    const request = isEditing
      ? {
          ...
          purchaseUnitOfMeasure: values.purchaseUnitOfMeasure,
    ...
    <Form
      ...
      onValuesChange={(changedValues) => {
        if ("productId" in changedValues)
          form.setFieldValue("purchaseUnitOfMeasure", undefined);
      }}
    ...
    >
      <Form.Item
        ...
        rules={[
          {
            required: true,
            message: t("purchasing.catalogue.supplierRequired"),
          },
        ]}
      >
        <Select
          disabled={isEditing || suppliers.isLoading}
      ...
      <Form.Item
        label={t("purchasing.catalogue.product")}
        name="productId"
        rules={[
          {
            required: true,
            message: t("purchasing.catalogue.productRequired"),
          },
        ]}
      >
        <Select
          disabled={isEditing || products.isLoading}
      ...
      <Form.Item
        label={t("purchasing.catalogue.supplierSku")}
        name="supplierSku"
        rules={[
          {
            max: purchasingValidation.maxSupplierSkuLength,
            message: t("purchasing.catalogue.supplierSkuMax", {
              max: purchasingValidation.maxSupplierSkuLength,
            }),
          },
        ]}
      >
        <Input maxLength={purchasingValidation.maxSupplierSkuLength} />
      </Form.Item>
      <Form.Item
        label={t("purchasing.catalogue.purchaseUnit")}
        name="purchaseUnitOfMeasure"
        rules={[
          {
            required: true,
            message: t("purchasing.catalogue.purchaseUnitRequired"),
          },
        ]}
      >
        <Select
      ...
      <Form.Item
        label={t("purchasing.catalogue.minimumOrderQuantity")}
        extra={t("purchasing.catalogue.minimumOrderQuantityHelp")}
        name="minimumOrderQuantity"
        rules={[
          {
            required: true,
            message: t("purchasing.catalogue.minimumOrderQuantityRequired"),
          },
        ]}
      >
      ...
      <Form.Item
        label={t("purchasing.catalogue.unitPrice")}
        extra={t("purchasing.catalogue.unitPriceHelp")}
        name="unitPrice"
        rules={[
          {
            required: true,
            message: t("purchasing.catalogue.unitPriceRequired"),
          },
        ]}
      >
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            message: t("purchasing.catalogue.currencyCodeRequired"),
          },
        ]}
      >
        <Select
          disabled={currencies.isLoading || isSubmitting}
