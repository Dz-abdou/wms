...
namespace Warehouse.Infrastructure.Migrations
{
    ...
    [Migration("20260801184025_AddSalesOrderFulfillmentWarehouse")]
    partial class AddSalesOrderFulfillmentWarehouse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Domain.Sales.SalesOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SalesOrders", null, t =>
                        {
                            t.HasCheckConstraint("CK_SalesOrders_CurrencyCode_Uppercase", "\"CurrencyCode\" = upper(\"CurrencyCode\")");

                            t.HasCheckConstraint("CK_SalesOrders_Number_NotBlank", "btrim(\"Number\") <> ''");

                            t.HasCheckConstraint("CK_SalesOrders_Status_Valid", "\"Status\" IN (0, 1, 2)");
                        });
                });
            ...
            modelBuilder.Entity("Warehouse.Domain.Sales.SalesOrder", b =>
                {
                    ...
                    b.HasOne("Warehouse.Domain.Customers.CustomerAddress", null)
                        .WithMany()
                        .HasForeignKey("ShippingAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsMany("Warehouse.Domain.Sales.SalesOrderLine", "Lines", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid");
                            ...
                            b1.HasIndex("SalesOrderId", "LineNumber")
                                .IsUnique();

                            b1.ToTable("SalesOrderLines", null, t =>
                                {
                                    t.HasCheckConstraint("CK_SalesOrderLines_Quantity_Positive", "\"Quantity\" > 0");
                                });
                    ...
                    b.OwnsOne("Warehouse.Domain.Sales.SalesOrderShippingAddress", "ShippingAddress", b1 =>
                        {
                            b1.Property<Guid>("SalesOrderId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<string>("CountryCode")
                                ...
                                .HasMaxLength(2)
                                .HasColumnType("character varying(2)")
                                .HasColumnName("ShippingAddressCountryCode");

                            b1.Property<string>("DeliveryInstructions")
                                .HasMaxLength(1000)
                                .HasColumnType("character varying(1000)")
                                .HasColumnName("ShippingAddressInstructions");

                            b1.Property<string>("Label")
                                .IsRequired()
                                .HasMaxLength(100)
                                .HasColumnType("character varying(100)")
                                .HasColumnName("ShippingAddressLabel");
                    ...
                    b.OwnsMany("Warehouse.Domain.Sales.SalesOrderStatusHistory", "StatusHistory", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("SalesOrderStatusHistory", (string)null);
